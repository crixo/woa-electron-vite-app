...
function formatRecordset(sqlQuery) {
...
// MAIN EXECUTION
//ipcMain.handle("open-file-dialog", async (_, userRequest) => {
    // const userRequest = process.argv[2];
    // const schemaFile = process.argv[3];
    // const outputFolder = process.argv[4];
    // const schemaFile = '../../scripts/schema.txt';
    // const outputFolder = '../../logs';
    ...
    const formattedPrompt = formatRecordset(sqlQuery);
